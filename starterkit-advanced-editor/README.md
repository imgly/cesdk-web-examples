# Advanced Editor Starter Kit

This starter kit demonstrates how to integrate and customize the CE.SDK Advanced Editor for your web application. The Advanced Editor offers two integration approaches: you can import the turnkey configuration directly from NPM for immediate use, or download the starter kit to customize the configuration to match your specific requirements.

## Getting Started

The Advanced Editor offers two integration approaches. You can import the turnkey configuration directly from NPM for immediate use, or download the starter kit to customize the configuration to match your specific requirements.
...
### Install dependencies and run the Advanced Editor development server
...
The Advanced Editor starter kit is organized around configuration files that control different aspects of the editor. Each file manages a specific area—from enabling features to customizing UI layout and engine behavior.

```
starterkit-advanced-editor/
  └── src/
...
For complete documentation on integration, customization, and advanced features, visit the [Advanced Editor documentation](https://img.ly/docs/cesdk/web/prebuilt-solutions/advanced-editor+7a8c3e/).
