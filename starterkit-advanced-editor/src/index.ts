...
// import { AdvancedEditorConfig } from '@cesdk/cesdk-js/configs/starterkits-advanced-editor';
// Option 2: Import from local starter kit (for customization)
import { AdvancedEditorConfig } from './imgly/plugin';
...
CreativeEditorSDK.create('#cesdk_container', config)
  .then(async (cesdk) => {
    ...
    // Add the advanced editor plugin
