# Custom Editor Starter Kit

This starter kit demonstrates how to integrate and customize the CE.SDK Custom Editor for your web application. The Custom Editor offers two integration approaches: you can import the turnkey configuration directly from NPM for immediate use, or download the starter kit to customize the configuration to match your specific requirements.

## Getting Started

The Custom Editor offers two integration approaches. You can import the turnkey configuration directly from NPM for immediate use, or download the starter kit to customize the configuration to match your specific requirements.
...
### Install dependencies and run the Custom Editor development server
...
The Custom Editor starter kit is organized around configuration files that control different aspects of the editor. Each file manages a specific area—from enabling features to customizing UI layout and engine behavior.

```
starterkit-custom-editor/
  └── src/
...
The following sections explain how each file works and how you can customize it to build your own creative editor experience.
...
For complete documentation on integration, customization, and advanced features, visit the [Custom Editor documentation](https://img.ly/docs/cesdk/web/prebuilt-solutions/custom-editor+3a5c9b/).
