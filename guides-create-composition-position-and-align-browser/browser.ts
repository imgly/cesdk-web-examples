...
class Example implements EditorPlugin {
  ...
  private addNavigationButtons(
    ...
    cesdk.ui.insertNavigationBarOrderComponent('last', 'position-demo-btn');
    cesdk.ui.insertNavigationBarOrderComponent('last', 'align-demo-btn');
    cesdk.ui.insertNavigationBarOrderComponent('last', 'distribute-demo-btn');
    cesdk.ui.insertNavigationBarOrderComponent('last', 'snapping-demo-btn');
  }
