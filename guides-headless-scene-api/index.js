// highlight-setup
import 'https://cdn.img.ly/packages/imgly/cesdk-js/1.4.0-alpha.4/cesdk-engine.umd.js';
...
const SCENE_CONTENT = await fetch(
  'https://cdn.img.ly/packages/imgly/cesdk-js/1.4.0-alpha.4/assets/templates/cesdk_postcard_1.scene'
).then((response) => {
