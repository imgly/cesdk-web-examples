// highlight-setup
import CreativeEngine from 'https://cdn.img.ly/packages/imgly/cesdk-engine/1.8.0-alpha.2/index.js';

const config = {
  baseURL: 'https://cdn.img.ly/packages/imgly/cesdk-engine/1.8.0-alpha.2/assets'
};

// Fetch scene file and store it as a string.
const SCENE_CONTENT = await fetch(
  'https://cdn.img.ly/packages/imgly/cesdk-js/1.8.0-alpha.2/assets/templates/cesdk_postcard_1.scene'
).then((response) => {
