...
const SCENE_CONTENT = await fetch('https://cdn.img.ly/packages/imgly/cesdk-js/1.4.0-alpha.1/assets/templates/cesdk_postcard_1.scene')
...
CreativeEngine.init(document.getElementById('cesdk_canvas'), config).then(
  ...
  async (engine) => {
    ...
    scene = await engine.scene.loadFromURL('https://cdn.img.ly/packages/imgly/cesdk-js/1.4.0-alpha.1/assets/templates/cesdk_postcard_1.scene');
