...
const { PropertyType } = CreativeEngine;
...
CreativeEngine.init(config).then(async (engine) => {
  ...
  // highlight-PropertyType
  pointsType == PropertyType.Int; // true
  ...
  // highlight-setSize2
  engine.property.setSize2Width(camera, 'camera/resolution', 100);
  engine.property.setSize2Height(camera, 'camera/resolution', 100);
  // highlight-setSize2
  // highlight-getSize2
  engine.property.getSize2(camera, 'camera/resolution');
  // highlight-setEnum
