...
import 'https://cdn.img.ly/packages/imgly/cesdk-js/1.6.2/cesdk.umd.js';

CreativeEditorSDK.init('#cesdk_container').then(async (cesdk) => {
  // highlight-fetch-blob
  const sceneUrl = 'https://cdn.img.ly/packages/imgly/cesdk-js/1.6.2/assets/templates/cesdk_postcard_1.scene';
