// highlight-setup
import 'https://cdn.img.ly/packages/imgly/cesdk-js/1.4.0-alpha.6/cesdk-engine.umd.js';

const { PositionMode, SizeMode } = CreativeEngine;
...
CreativeEngine.init(config).then(async (engine) => {
  ...
  engine.block.setPositionXMode(block, PositionMode.Percent);
  // highlight-setPositionY
  engine.block.setPositionY(block, 0.25);
  // highlight-setPositionYMode
  engine.block.setPositionYMode(block, PositionMode.Percent);
  ...
  engine.block.setWidthMode(block, SizeMode.Percent);
  // highlight-setHeight
  engine.block.setHeight(block, 0.5);
  // highlight-setHeightMode
  engine.block.setHeightMode(block, SizeMode.Percent);
