...
// import { DesignEditorConfig } from '@cesdk/cesdk-js/configs/starterkits-design-editor';
// Option 2: Import from local starter kit (for customization)
import { DesignEditorConfig } from './imgly/plugin';
