import CreativeEngine from 'https://cdn.img.ly/packages/imgly/cesdk-engine/1.18.1-rc.1/index.js';

const config = {
  baseURL: 'https://cdn.img.ly/packages/imgly/cesdk-engine/1.18.1-rc.1/assets'
};
