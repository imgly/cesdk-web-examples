...
import { ExportPrintReadyPDFPanelPlugin } from './ExportPrintReadyPDFPanelPlugin';
...
const ExportPrintReadyPDFCESDK = () => {
  ...
  const configure = useConfigure(async (instance) => {
    ...
    await instance.addPlugin(ExportPrintReadyPDFPanelPlugin());
...
export default ExportPrintReadyPDFCESDK;
