...
try {
  ...
  const customFilters: AssetResult[] = [
    ...
    },
    {
      ...
      meta: {
        uri: 'https://cdn.img.ly/packages/imgly/cesdk-js/1.67.0-rc.0/assets/extensions/ly.img.cesdk.filters.lut/LUTs/imgly_lut_bw_5_5_128.png',
        thumbUri:
          'https://cdn.img.ly/packages/imgly/cesdk-js/1.67.0-rc.0/assets/extensions/ly.img.cesdk.filters.lut/LUTs/imgly_lut_bw_5_5_128.png',
        horizontalTileCount: '5',
        verticalTileCount: '5',
        blockType: '//ly.img.ubq/effect/lut_filter'
      }
