...
class Example implements EditorPlugin {
  ...
  async initialize({ cesdk }: EditorPluginContext): Promise<void> {
    ...
    // =============================================================================
    const { block: linearVerticalBlock, fill: linearVertical } = createShapeWithFill(
      'gradient/linear'
    );
  ...
  // Example 2: Linear Gradient (Horizontal)
    // =============================================================================
    const { block: linearHorizontalBlock, fill: linearHorizontal } = createShapeWithFill(
    'gradient/linear'
  );
  ...
  // Example 3: Linear Gradient (Diagonal)
    // =============================================================================
    const { block: linearDiagonalBlock, fill: linearDiagonal } = createShapeWithFill(
    'gradient/linear'
  );
  ...
  // Example 4: Multi-Stop Linear Gradient (Aurora Effect)
    // =============================================================================
    const { block: auroraGradientBlock, fill: auroraGradient } = createShapeWithFill(
    'gradient/linear'
  );
  ...
  // Example 5: Radial Gradient (Centered)
    // =============================================================================
    const { block: radialCenteredBlock, fill: radialCentered } = createShapeWithFill(
    'gradient/radial'
  );
  ...
  // Example 6: Radial Gradient (Top-Left Highlight)
    // =============================================================================
    const { block: radialHighlightBlock, fill: radialHighlight } = createShapeWithFill(
    'gradient/radial'
  );
  ...
  // Example 7: Radial Gradient (Vignette Effect)
    // =============================================================================
    const { block: radialVignetteBlock, fill: radialVignette } = createShapeWithFill(
    'gradient/radial'
  );
  ...
  // Example 8: Conical Gradient (Color Wheel)
    // =============================================================================
    const { block: conicalColorWheelBlock, fill: conicalColorWheel } = createShapeWithFill(
    'gradient/conical'
  );
  ...
  // Example 9: Conical Gradient (Loading Spinner)
    // =============================================================================
    const { block: conicalSpinnerBlock, fill: conicalSpinner } = createShapeWithFill(
    'gradient/conical'
  );
  ...
  // Example 10: Gradient with CMYK Colors
    // =============================================================================
    const { block: cmykGradientBlock, fill: cmykGradient } = createShapeWithFill(
    'gradient/linear'
  );
  ...
  // Example 11: Gradient with Spot Colors
    ...
    const { block: spotGradientBlock, fill: spotGradient } = createShapeWithFill(
    'gradient/linear'
  );

    engine.block.setGradientColorStops(spotGradient, 'fill/gradient/colors', [
    { color: { name: 'BrandPrimary', tint: 1.0, externalReference: '' }, stop: 0 },
    { color: { name: 'BrandSecondary', tint: 1.0, externalReference: '' }, stop: 1 }
  ]);
  ...
  // Example 12: Transparency Overlay Gradient
    // =============================================================================
    const { block: overlayGradientBlock, fill: overlayGradient } = createShapeWithFill(
    'gradient/linear'
  );
  ...
  // Example 13: Duotone Gradient
    // =============================================================================
    const { block: duotoneGradientBlock, fill: duotoneGradient } = createShapeWithFill(
    'gradient/linear'
  );
  ...
  // Example 15: Get Gradient Properties
    // =============================================================================
    const { block: inspectGradientBlock, fill: inspectGradient } = createShapeWithFill(
    'gradient/linear'
  );
