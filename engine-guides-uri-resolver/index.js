...
CreativeEditorSDK.create('#cesdk_container', config).then((instance) => {
  ...
  /** This will return 'https://cdn.img.ly/packages/imgly/cesdk-js/1.23.0/assets/banana.jpg'. */
  ...
  /** Since we've removed the custom resolver, this will return 'https://cdn.img.ly/packages/imgly/cesdk-js/1.23.0/assets/banana.jpg' like before. */
  instance.engine.editor.getAbsoluteURI('/banana.jpg');
  // highlight-remove-resolver
});
