import CreativeEditorSDK from 'https://cdn.img.ly/packages/imgly/cesdk-js/1.31.1-rc.1/index.js';

const config = {
  license: 'vERESgSXbYj5Rs-FF4DzkMvhdQLh0Mxe6AD8V-doP6wqe_gmYmx_oUKqIlMkwpMu',
  userId: 'guides-user',
  baseURL: 'https://cdn.img.ly/packages/imgly/cesdk-js/1.31.1-rc.1/assets'
};

CreativeEditorSDK.create('#cesdk_container', config).then((instance) => {
  // highlight-get-absolute-base-path
  /** This will return 'https://cdn.img.ly/packages/imgly/cesdk-js/1.31.1-rc.1/assets/banana.jpg'. */
  ...
  /** Since we've removed the custom resolver, this will return 'https://cdn.img.ly/packages/imgly/cesdk-js/1.31.1-rc.1/assets/banana.jpg' like before. */
  instance.engine.editor.getAbsoluteURI('/banana.jpg');
  // highlight-remove-resolver
});
