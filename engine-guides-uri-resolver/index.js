import 'https://cdn.img.ly/packages/imgly/cesdk-js/1.12.2/cesdk.umd.js';

let config = {
  baseURL: 'https://cdn.img.ly/packages/imgly/cesdk-js/1.12.2/assets',
};

CreativeEditorSDK.init('#cesdk_container', config).then((instance) => {
  // highlight-get-absolute-base-path
  /** This will return 'https://cdn.img.ly/packages/imgly/cesdk-js/1.12.2/assets/banana.jpg'. */
  ...
  */
  ...
  /** Since we've removed the custom resolver, this will return 'https://cdn.img.ly/packages/imgly/cesdk-js/1.12.2/assets/banana.jpg' like before. */
  instance.engine.editor.getAbsoluteURI('/banana.jpg')
  // highlight-remove-resolver
});
