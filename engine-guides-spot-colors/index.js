import CreativeEngine from 'https://cdn.img.ly/packages/imgly/cesdk-engine/1.15.0-rc.0/index.js';

const config = {
  baseURL: 'https://cdn.img.ly/packages/imgly/cesdk-engine/1.15.0-rc.0/assets'
};
