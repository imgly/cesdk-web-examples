...
```bash
git clone https://github.com/imgly/starterkit-design-viewer-web.git
```

### Install Dependencies

```bash
cd starterkit-design-viewer-web
npm install
```
...
For complete integration guides and API reference, visit the [Design Viewer Documentation](https://img.ly/docs/cesdk/web/prebuilt-solutions/viewer+5e7f2a/).
