import CreativeEngine from 'https://cdn.img.ly/packages/imgly/cesdk-engine/1.57.1-rc.0/index.js';

const config = {
  license: 'vERESgSXbYj5Rs-FF4DzkMvhdQLh0Mxe6AD8V-doP6wqe_gmYmx_oUKqIlMkwpMu',
  userId: 'guides-user',
  baseURL: 'https://cdn.img.ly/packages/imgly/cesdk-engine/1.57.1-rc.0/assets'
};
...
CreativeEngine.init(config).then(async (engine) => {
  ...
  engine.block.setString(
    ...
    'https://cdn.img.ly/packages/imgly/cesdk-js/1.57.1-rc.0/assets/extensions/ly.img.cesdk.filters.lut/LUTs/imgly_lut_ad1920_5_5_128.png'
  );
