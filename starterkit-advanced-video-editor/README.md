...
Full-featured video editing for your web app with an advanced desktop-style interface—multi-track timeline, layers panel, and professional export options. Runs entirely in the browser with no server dependencies.
...
```bash
git clone https://github.com/imgly/starterkit-advanced-video-editor-web.git
```

### Install Dependencies

```bash
cd starterkit-advanced-video-editor-web
npm install
```
...
```
starterkit-advanced-video-editor-web/
├── src/
...
For complete integration guides and API reference, visit the [Advanced Video Editor Documentation](https://img.ly/docs/cesdk/web/prebuilt-solutions/advanced-video-editor+6b9d4f/).
