...
// import { AdvancedVideoEditorConfig } from '@cesdk/cesdk-js/configs/starterkits-advanced-video-editor';
// Option 2: Import from local starter kit (for customization)
import { AdvancedVideoEditorConfig } from './imgly/plugin';
...
CreativeEditorSDK.create('#cesdk_container', config)
  .then(async (cesdk) => {
    ...
    // Add the advanced video editor plugin
