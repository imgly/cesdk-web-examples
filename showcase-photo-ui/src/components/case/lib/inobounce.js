...
var handleTouchmove = function (evt) {
  ...
  while (el !== document.body && el !== document) {
    ...
    if (overflowX === 'scroll' || overflowX === 'auto') {
      ...
      // Try resetting scroll container scroll
      const scrollCaseContainer = document.getElementById('scroll-container');
      if (scrollCaseContainer) {
        scrollCaseContainer.scrollTop = 0;
      }
