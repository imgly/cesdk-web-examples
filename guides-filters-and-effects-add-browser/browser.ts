...
class Example implements EditorPlugin {
  ...
  async initialize({ cesdk }: EditorPluginContext): Promise<void> {
    ...
    engine.asset.addAssetToSource('ly.img.filter.lut', {
      ...
      meta: {
        uri: 'https://cdn.img.ly/packages/imgly/cesdk-js/1.66.1-rc.0/assets/extensions/ly.img.cesdk.filters.lut/LUTs/imgly_lut_ad1920_5_5_128.png',
        thumbUri:
          'https://cdn.img.ly/packages/imgly/cesdk-js/1.66.1-rc.0/assets/extensions/ly.img.cesdk.filters.lut/LUTs/imgly_lut_ad1920_5_5_128.png',
