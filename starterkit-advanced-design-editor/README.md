...
Full-featured design editing for your web app with an advanced desktop-style interface—layers panel, precise controls, and professional export options. Runs entirely in the browser with no server dependencies.
...
```bash
git clone https://github.com/imgly/starterkit-advanced-design-editor-web.git
```

### Install Dependencies

```bash
cd starterkit-advanced-design-editor-web
npm install
```
...
```
starterkit-advanced-design-editor-web/
├── src/
...
For complete integration guides and API reference, visit the [Advanced Design Editor Documentation](https://img.ly/docs/cesdk/web/prebuilt-solutions/advanced-editor+7a8c3e/).
